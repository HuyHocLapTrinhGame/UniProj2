...
public class Url {
    ...
    //Feedback
    public static final String FEEDBACK_CONTROLLER      = "/main/feedback";
    public static final String FEEDBACK_LIST_PAGE       = "/feedbackList.jsp";
    public static final String CREATE_FEEDBACK_PAGE     = "/createFeedback.jsp";
    public static final String UPDATE_FEEDBACK_PAGE     = "/updateFeedback.jsp";
}
